...
public class View extends JFrame {
    ...
    org.example.GraphicalUserInterface.Controller controller = new org.example.GraphicalUserInterface.Controller(this);
    ...
    private void prepareNumbersPanel() {
        ...
        String[] operations = new String[]{"Add", "Subtract", "Multiply", "Integration", "Derivative"};
